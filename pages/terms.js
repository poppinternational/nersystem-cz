...
const Terms = () => {
  return (
    <Layout>
      <Head>
        <title>NER System – Terms of Service</title>
        <meta property="og:title" content="NER System – Terms of Service" />
        <meta
      ...
      <div className="max-w-5xl mx-auto py-16 px-4 sm:py-24 sm:px-6 lg:px-8">
        ...
        <p className="mt-4">
          ...
          related to it, still belong to NER System s.r.o..
        </p>{" "}
        <p className="mt-4">
          NER System s.r.o. is committed to ensuring that the app is as useful
        ...
        <p className="mt-4">
          The NER Attend app stores and processes personal data that you have
          ...
          security features and it could mean that the NER Attend app won’t work
          properly or at all.
        </p>{" "}
        <div>
          <p className="mt-4">
        ...
        <p className="mt-4">
          You should be aware that there are certain things that NER System
          s.r.o. will not take responsibility for. Certain functions of the app
          ...
          but NER System s.r.o. cannot take responsibility for the app not
        ...
        <p className="mt-4">
          Along the same lines, NER System s.r.o. cannot always take
          ...
          can’t turn it on to avail the Service, NER System s.r.o. cannot accept
          responsibility.
        </p>{" "}
        <p className="mt-4">
          With respect to NER System s.r.o.’s responsibility for your use of the
          ...
          that we can make it available to you. NER System s.r.o. accepts no
        ...
        <p className="mt-4">
          ...
          keep using the app. NER System s.r.o. does not promise that it will
        ...
        <p className="mt-4">
          ...
          Conditions, do not hesitate to contact us at info@nersystem.cz.
        </p>
      </div>
    </Layout>
  );
