...
const PrivacyPolicy = () => {
  return (
    <Layout>
      <Head>
        <title>NER System – Privacy policy</title>
        <meta property="og:title" content="NER System – Privacy policy" />
        <meta
      ...
      <div className="max-w-5xl mx-auto py-16 px-4 sm:py-24 sm:px-6 lg:px-8">
        ...
        <p className="mt-8">
          NER System s.r.o. built the NER Attend app as a Commercial app. This
          SERVICE is provided by NER System s.r.o. and is intended for use as
          is.
        </p>{" "}
        <p>
        ...
        <p>
          ...
          Terms and Conditions, which are accessible at NER Attend unless
        ...
        <p>
          ...
          including but not limited to Full name, email address. The information
        ...
        <p>
          <h2 className="text-lg font-bold mt-4">Log Data</h2>
        </p>{" "}
        <p>
        ...
        <p>
          <h2 className="text-lg font-bold mt-4">Service Providers</h2>
        </p>{" "}
        <p>
        ...
        <p>
          <h2 className="text-lg font-bold mt-4">Links to Other Sites</h2>
        </p>{" "}
        <p>
        ...
        <p>
          <h2 className="text-lg font-bold mt-4">Children’s Privacy</h2>
        </p>{" "}
        <div>
          <p>
        ...
        <p>
          ...
          not hesitate to contact us at info@nersystem.cz.
        </p>
      </div>
    </Layout>
  );
